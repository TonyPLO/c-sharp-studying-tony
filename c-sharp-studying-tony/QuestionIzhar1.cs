...
namespace c_sharp_studying_tony
{
    public class QuestionIzhar1
    {
        ...
        public static void Demo()
        {
            ...
            result = QuestionIzhar1.Sum(1, 2);
            Console.WriteLine("result=" + result);
            result = QuestionIzhar1.Sum(-1, 1);
            Console.WriteLine("result=" + result);

            int number = 0;
            number = QuestionIzhar1.Factorial(1);
            Console.WriteLine("number=" + number);
            number = QuestionIzhar1.Factorial(5);
            Console.WriteLine("number=" + number);
        }
